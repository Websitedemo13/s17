...
import { TrendingUp, TrendingDown, Users, Shield, Copy, CheckCircle, Star, Activity } from "lucide-react"
...
export function TraderCard({ trader }: TraderCardProps) {
  ...
  return (
    <Card className="bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className={`font-semibold ${trader.monthlyReturn >= 0 ? "text-emerald-400" : "text-red-400"}`}>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-800">
          ...
          <div className="text-sm text-gray-400">${trader.copyCost}/month</div>
        </div>
        ...
        <div className="pt-2">
          ...
          <Button
            ...
            disabled={isLoading}
            className={`w-full ${
              isCopied ? "bg-red-600 hover:bg-red-700 text-white" : "bg-emerald-600 hover:bg-emerald-700 text-white"
            }`}
          >
